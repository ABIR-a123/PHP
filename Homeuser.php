                            ...
                            if ($numErrorsh == 0) 
                            {
                                if($remseats >= $nofseats)
                                {
                                     $insertbook = "INSERT INTO booking(fname,phone,mname,date,time,type,seats,price) VALUES('$name','$cphone','$movie','$date','$time','$type','$nofseats','$totalprice')";  
                                        ...
                                        $qseat = "SELECT seats,price FROM shows WHERE mname='$movie' AND date='$date' AND time='$time' AND type='$type'";
                                        $search_Result = mysqli_query($db, $qseat);
                  ...
                  <div id="seatpattern" class="seatpattern">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              ...
                              <p class="text">
                                  You have selected <span id="noofseats">0</span> seats for a price of tk <span id="seatprice">0</span>
                              </p>
                          </div>
                      </div>
                  </div>
            ...
            <div id="settings">
                <h4>
                    <div class="card">
                        ...
                        <br><br><br>
                        <tr>
                            <input type="submit" name="Submit" value="Change Passowrd" id="btneditpass">
                        </tr>
                    </div>
                </h4>
            </div>
...
{
  $(".buttonsforbook").prop("disabled", true);
}

function takeData()
{
  if (( $("#movie").val().length == 0) || ( $("#date").val().length == 0 )  ||  ( $("#time").val().length == 0 ) ||  ( $("#seats").val().length == 0 ) || ($("#seattype").val().length == 0) || ($("#phoneno").val().length == 0))
  {
    alert("Please Enter movie details to book Seats");
  }
  else
  {
    $(".buttonsforbook").prop("disabled", false);
  }
}*/
</script>